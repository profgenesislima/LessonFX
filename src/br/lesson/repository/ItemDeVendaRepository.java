...
import br.lesson.domain.ItemDeVenda;
import br.lesson.domain.Produto;
import br.lesson.domain.Venda;

public class ItemDeVendaRepository {
    ...
    public boolean inserir(ItemDeVenda itemDeVenda) {
        ...
        try {
            ...
            Logger.getLogger(ItemDeVendaRepository.class.getName()).log(Level.SEVERE, null, ex);
            return false;
        }
    }
    ...
    public List<ItemDeVenda> listar() {
        ...
        try {
            ...
            while (resultado.next()) {
                ...
                produtoRepository.setConnection(connection);
                produto = produtoRepository.buscar(produto);
                
                VendaRepository vendaRepository = new VendaRepository();
                vendaRepository.setConnection(connection);
                venda = vendaRepository.buscar(venda);
    ...
    public List<ItemDeVenda> listarPorVenda(Venda venda) {
        ...
        try {
            ...
            while (resultado.next()) {
                ...
                //Obtendo os dados completos do Produto associado ao Item de Venda
                ProdutoRepository produtoDAO = new ProdutoRepository();
