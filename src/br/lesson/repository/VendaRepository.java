...
import br.lesson.domain.Cliente;
    ...
    public List<Venda> listar() {
        ...
        try {
            ...
            while (resultado.next()) {
                ...
                clienteRepository.setConnection(connection);
                cliente = clienteRepository.buscar(cliente);

                //Obtendo os dados completos dos Itens de Venda associados à Venda
                ItemDeVendaRepository itemDeVendaRepository = new ItemDeVendaRepository();
                itemDeVendaRepository.setConnection(connection);
                itensDeVenda = itemDeVendaRepository.listarPorVenda(venda);
