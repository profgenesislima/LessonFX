...
import br.lesson.repository.ClienteRepository;
...
public class FXMLAnchorPaneCadastrosClientesController implements Initializable {
    ...
    public boolean showFXMLAnchorPaneCadastrosClientesDialog(Cliente cliente) throws IOException {
        ...
        loader.setLocation(FXMLAnchorPaneCadastrosClientesDialogController.class.getResource("/br/nabuco/javafx/view/FXMLAnchorPaneCadastrosClientesDialog.fxml"));
